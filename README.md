...
* :white_check_mark: [Sioyek](https://github.com/ahrm/sioyek) - Both keyboard and (optionnally) mouse focused. Configurable and has the possibility of adding and developing plugins.
